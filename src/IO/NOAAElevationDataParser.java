...
import static IO.NOAAElevationDataParser.INDICIES.*;
/**
 @author david
 created: 2015-03-05
 ...
 description: */
public class NOAAElevationDataParser
{
   ...
   */
  public NOAAElevationDataParser(String rootPath, int outputCellSize)
  {
    root = rootPath;
  ...
  {
    NOAAElevationDataParser p = 
      new NOAAElevationDataParser("/Users/david/cs351/Food_Project/all10",10);
