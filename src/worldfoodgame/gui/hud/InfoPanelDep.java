...
import worldfoodgame.gui.displayconverters.AmericanUniteConverter;
import worldfoodgame.gui.displayconverters.DisplayUnitConverter;
import worldfoodgame.gui.displayconverters.MetricDisplayConverter;
import worldfoodgame.gui.regionlooks.PlantingZoneView;
...
import static worldfoodgame.gui.ColorsAndFonts.BAR_GRAPH_NEG;
import static worldfoodgame.gui.ColorsAndFonts.GUI_BACKGROUND;
...
public class InfoPanelDep extends JPanel implements Observer
{
  ...
  /**
   * Convert the happiness double into a string for worldfoodgame.gui presentation.
   */
  ...
  private RegionAttributes sumAttributes(List<GUIRegion> regions)
  {
    ...
    /* find the most worldfoodgame.common planting zone */
