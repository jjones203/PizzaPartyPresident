 ...
 * terms of the worldfoodgame.model unit system, which uses the customary United States units.
 * <p/>
...
public abstract class DisplayUnitConverter
{
   ...
   * <p/>
   * Note, this class creates a new object, it does not mutate the worldfoodgame.model data!
   * <p/>
   ...
   *
   * @param originalSet worldfoodgame.model unite RegionAttributes object
